...
#### Snowy短视频 —— 基于 uni-app 与 Springboot 开发（前端部分）

#### 项目UI框架为 ColorUI，另外感谢本项目使用到的搜索等插件的提供者~

### 环境依赖

* uni-app 开发工具 HBuilderX；
...
* 后端相关配置介绍有待更新。项目地址：[点这里 ฅʕ•̫͡•ʔฅ](https://github.com/LIsemd/Snowy-video-server)
